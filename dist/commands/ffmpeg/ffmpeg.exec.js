...
var comand_executor_1 = require("../../core/executor/comand.executor");
...
var FfmpegExecutor = /** @class */ (function (_super) {
    ...
    FfmpegExecutor.prototype.prompt = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.promptService.input('Width', 'number')];
                    case 1:
                        width = _a.sent();
                        return [4 /*yield*/, this.promptService.input('Height', 'number')];
                    case 2:
                        height = _a.sent();
                        return [4 /*yield*/, this.promptService.input('Path', 'input')];
                    case 3:
                        path = _a.sent();
                        return [4 /*yield*/, this.promptService.input('Name', 'input')];
                    case 4:
                        name = _a.sent();
    ...
    FfmpegExecutor.prototype.spawn = function (_a) {
        var command = _a.command, args = _a.args, output = _a.output;
...
}(comand_executor_1.CommandExecutor));
